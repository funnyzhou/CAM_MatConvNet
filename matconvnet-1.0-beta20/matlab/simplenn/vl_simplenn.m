...
for i=1:n
  ...
  switch l.type
    ...
    case 'adaptive_pooling'
            l.opts{:} = {} ;
            [res(i+1).x, averagepooling] = vl_nnadaptive_pooling(res(i).x,l,...
              l.pad, l.stride, ...
              l.method, l.opts{:}, ...
              cudnn{:});
    ...
    case 'multi_label_loss'
      res(i+1).x = vl_nnmultilabelloss(res(i).x, l.class) ;
...
if doder
  ...
  for i=n:-1:backPropLim
    ...
    switch l.type
      ...
      case 'adaptive_pooling'
            l.opts{:} = {} ;
            [res(i).dzdx, averagepooling]=vl_nnadaptive_pooling(res(i).x, averagepooling, ...
                l.pad, l.stride, l.method, l.opts{:}, ...
                cudnn{:}, res(i+1).dzdx);
      ...
      case 'multi_label_loss'
        res(i).dzdx = vl_nnmultilabelloss(res(i).x, l.class, res(i+1).dzdx) ;
